...
echo "───────────────────────────────────────────────────────────────"
echo "Start all:    docker-compose --env-file .env.mcp -f docker-compose-mcp.yml up -d"
echo "Stop all:     docker-compose --env-file .env.mcp -f docker-compose-mcp.yml down"
echo "View logs:    docker-compose --env-file .env.mcp -f docker-compose-mcp.yml logs -f"
echo "Restart:      docker-compose --env-file .env.mcp -f docker-compose-mcp.yml restart"
echo ""
